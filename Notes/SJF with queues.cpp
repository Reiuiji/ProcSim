...
int main()
{
	...
	int LOP = 0;
	int READY_QUEUE[50], IO_QUEUE[50]; // The queues. These are here because I'm bad at things.
	...
	for(i=0; i<NUM_PROCESSES; i++)
	{
		...
		// If it doesn't, it sets the half burst time to 0.
		else 
		{Q_Pos[i].CPU_WITH_IO = 0;}
	}
